...
public class BookingService {
	...
	public PageResponse<BookingResponse> getBookingsByBuyer(Integer buyerId, int page, int size, String sortBy,
			String direction) {
		...
		return new PageResponse<>(
				...
				bookingPage.getNumber(), bookingPage.getSize(), bookingPage.getTotalElements(),
				bookingPage.getTotalPages());
	}

	public PageResponse<BookingResponse> getBookingsBySeller(Integer sellerId, int page, int size, String sortBy,
			String direction) {
		Sort sort = direction.equalsIgnoreCase("desc") ? Sort.by(sortBy).descending() : Sort.by(sortBy).ascending();
		Pageable pageable = PageRequest.of(page, size, sort);
